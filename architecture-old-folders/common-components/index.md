...
To help us deliver the above, we’ve joined forces with the Design profession to review our cloud strategy. This includes considering how to evolve as a central provider of cloud services and where hot topics like 'multi-vendor' and containerisation fit with our future thinking.
...
If you're considering your options and want more advice, get in touch with your [Design Lead](../profession/our-profession-offer/#Design-leads).
...
For more information on common components or to discuss adding your component to the repository, contact the [Design profession](mailto:Design.profession@education.gov.uk)
